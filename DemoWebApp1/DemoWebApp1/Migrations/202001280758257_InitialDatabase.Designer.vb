...
Namespace Migrations
    ...
    Public NotInheritable Partial Class InitialDatabase
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(InitialDatabase))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202001280758257_InitialDatabase"
            End Get
        End Property
